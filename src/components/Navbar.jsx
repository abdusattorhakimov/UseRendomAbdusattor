...
import "./Navbar.css";
import createContext from "../hooks/newThemecontext";

function Navbar() {
  const { mode, changeMode } = createContext();
  const HandilMode = () => {
    ...
    <div>
      <header className="header">
        <div className="container header__container">
          ...
          {mode === "light" && (
            <button id="dark-btn" onClick={HandilMode}>
          ...
          {mode === "dark" && (
            <button id="light-btn" onClick={HandilMode} className={` ${mode}`}>
              <svg xmlns="http://www.w3.org/2000/svg" height="40" width="40">
                <path
